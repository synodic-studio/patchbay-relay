...
| `stargate/harness/` | Pluggable agent backends — `base.py` = protocol + TurnEvent types, `claude_cli.py` = CLI subprocess backend, `claude_sdk.py` = Claude Agent SDK backend. See `docs/HARNESS-DESIGN.md`. CTB-cyz. |

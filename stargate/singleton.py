...
CTB-72m: without this, two bridge processes can poll Telegram's getUpdates
simultaneously during restart overlap. Telegram returns 409 Conflict to the
second, which logs it 1000+ times but never exits. Prior symptom: the
04-18 outage and a bridge.log full of "terminated by other getUpdates request".
